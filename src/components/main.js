            ...
            <div>
                <div className=" w-full overflow-hidden  content-center grid  ">
                    ...
                    <div className=" max-w-full  m-auto overflow-hidden    ">
                        {/* marquee 👇 */}
                        <div className=" flex gap-7 md:gap-12   bg-gradient-to-t from-black via-gray-500 to-black text-pink-500 ">
                        ...
                        <div className=" max-w-7xl m-auto sm:flex  mt-14  ">
                            ...
                            >
                                <div className=" sun bg-pink-600  h-11 w-11 rounded-full border-4 border-pink-600 absolute left-0"></div>
                            ...
                            >
                                <div className=" sun2 bg-emerald-500  h-11 w-11 rounded-full absolute right-0"></div>
                                <div className=" m-5 mb-0 text-3xl font-semibold capitalize text-gray-300">
                                    In Backend
                                </div>
                                <div>
                        ...
                        <div className=" max-w-7xl m-auto sm:flex  mt-10  ">
                            ...
                            >
                                <div className=" sun4 bg-sky-400  h-11 w-11 rounded-full  absolute left-0"></div>
                                <div className=" m-5 mb-0 text-3xl font-semibold capitalize text-gray-300">
                                    In blockchain
                                </div>
                                <div>
                            ...
                            >
                                <div className=" sun3 bg-yellow-400  h-11 w-11 rounded-full  absolute right-0"></div>
                                <div className=" m-5 mb-0 text-3xl font-semibold capitalize text-gray-300">
                                    some Knowledge
                                </div>
                                <div>
