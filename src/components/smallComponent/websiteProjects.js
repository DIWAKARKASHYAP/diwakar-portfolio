...
const WebsiteProjects = () => {
    ...
    return (
        <div>
            <div
                id="web-development"
                className=" bg-gradient-to-r from-pink-300 via-green-300 to-yellow-200 max-w-7xl h-1 rounded-xl m-auto mt-16 mb-20"
            ></div>
                    ...
                    <div className=" relative  max-w-sm p-1   rounded-lg shadow   ">
                        <div className=" bg-gray-950 rounded-md">
                            ...
                            <div className="p-5">
                                ...
                                <p className="mb-3 font-normal text-gray-500">
                                    Our blockchain remote job platform is built
                                    on Next.js, Tailwind CSS, MUI, and Flowbit
                                    CSS. Firebase is utilized as the reliable
                                    database, ensuring seamless functionality
                                    and data management.{" "}
                                </p>
                                <div className="flex justify-between mt-4 space-x-3 md:mt-6">
                                    <a
                    ...
                    <div className=" relative  max-w-sm p-1   rounded-lg shadow   ">
                        <div className=" bg-gray-950 rounded-md">
                            ...
                            <div className="p-5">
                                ...
                                <p className="mb-3 font-normal text-gray-500">
                                    This portfolio, crafted with React.js,
                                    features seamless animations using the AOS
                                    library. Styled with Tailwind CSS and MUI,
                                    it offers a visually appealing and
                                    interactive platform to showcase creative
                                    works and skills..
                                </p>
                                <div className="flex justify-between mt-4 space-x-3 md:mt-6">
                                    <a
